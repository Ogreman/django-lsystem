...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Branch.colour'
        db.add_column(u'lsystem_branch', 'colour',
                      self.gf('django.db.models.fields.CharField')(default='255,255,255', max_length=12),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Branch.colour'
        db.delete_column(u'lsystem_branch', 'colour')
    ...
    models = {
        ...
        u'lsystem.branch': {
            ...
            'colour': ('django.db.models.fields.CharField', [], {'default': "'255,255,255'", 'max_length': '12'}),
