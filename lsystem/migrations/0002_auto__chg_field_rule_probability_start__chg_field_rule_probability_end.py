...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Rule.probability_start'
        db.alter_column(u'lsystem_rule', 'probability_start', self.gf('django.db.models.fields.PositiveIntegerField')(default=0))

        # Changing field 'Rule.probability_end'
        db.alter_column(u'lsystem_rule', 'probability_end', self.gf('django.db.models.fields.PositiveIntegerField')(default=0))
